...
struct FeedEventClassificationTests {
    ...
    @Test func copilotUsesDocumentedLifecycleHooksAndKeepsPreToolTelemetryOnly() throws {
        ...
        #expect(classify("copilot", "preToolUse", tool: "Bash").name == "PreToolUse")
        #expect(classify("copilot", "preToolUse", tool: "Bash").actionable == false)
    }
